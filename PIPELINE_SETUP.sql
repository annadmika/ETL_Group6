...
WHEN MATCHED AND src.rn = 1 THEN UPDATE SET
    ...
    REPORTING_MONTH = src.REPORTING_MONTH,
...
WHEN NOT MATCHED AND src.rn = 1 THEN INSERT (
    RECORD_ID, REPORTING_MONTH, WAREHOUSE_ID, WAREHOUSE_NAME, WAREHOUSE_COUNTRY,
    ORIGIN_COUNTRY, DISTANCE_CLASS, SHIPPING_METHOD, SHIPMENTS_COUNT,
    AVG_BATCH_SIZE_KG, ESTIMATED_EMISSIONS_KGCO2E, RAW_PAYLOAD
)
VALUES (
    src.RECORD_ID, src.REPORTING_MONTH, src.WAREHOUSE_ID, src.WAREHOUSE_NAME, src.WAREHOUSE_COUNTRY,
